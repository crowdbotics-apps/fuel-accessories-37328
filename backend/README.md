...
## Project Structure
    ...
    ├── fuel_accessories_37328  # Django project configurations
...
1. Clone this repo and `cd fuel_accessories_37328`
...
2. Clone this repo and `cd fuel_accessories_37328`
